...
#14 naming to docker.io/nautobot-plugin-meme-otd/nautobot:latest-py3.7 done
```
...
Creating network "nautobot_meme_otd_default" with the default driver
Creating volume "nautobot_meme_otd_postgres_data" with default driver
Creating nautobot_meme_otd_redis_1 ... 
Creating nautobot_meme_otd_docs_1  ... 
Creating nautobot_meme_otd_postgres_1 ... 
Creating nautobot_meme_otd_postgres_1 ... done
Creating nautobot_meme_otd_redis_1    ... done
Creating nautobot_meme_otd_nautobot_1 ... 
Creating nautobot_meme_otd_docs_1     ... done
Creating nautobot_meme_otd_nautobot_1 ... done
Creating nautobot_meme_otd_worker_1   ... 
Creating nautobot_meme_otd_worker_1   ... done
...
ee90fbfabd77   nautobot-plugin-meme-otd/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_meme_otd_worker_1
b8adb781d013   nautobot-plugin-meme-otd/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_meme_otd_nautobot_1
d64ebd60675d   nautobot-plugin-meme-otd/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_meme_otd_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nautobot_meme_otd_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_meme_otd_redis_1
```
...
Stopping nautobot_meme_otd_worker_1   ... 
Stopping nautobot_meme_otd_nautobot_1 ... 
Stopping nautobot_meme_otd_docs_1     ... 
Stopping nautobot_meme_otd_redis_1    ... 
Stopping nautobot_meme_otd_postgres_1 ... 
Stopping nautobot_meme_otd_worker_1   ... done
Stopping nautobot_meme_otd_nautobot_1 ... done
Stopping nautobot_meme_otd_postgres_1 ... done
Stopping nautobot_meme_otd_redis_1    ... done
Stopping nautobot_meme_otd_docs_1     ... done
Removing nautobot_meme_otd_worker_1   ... 
Removing nautobot_meme_otd_nautobot_1 ... 
Removing nautobot_meme_otd_docs_1     ... 
Removing nautobot_meme_otd_redis_1    ... 
Removing nautobot_meme_otd_postgres_1 ... 
Removing nautobot_meme_otd_postgres_1 ... done
Removing nautobot_meme_otd_docs_1     ... done
Removing nautobot_meme_otd_worker_1   ... done
Removing nautobot_meme_otd_redis_1    ... done
Removing nautobot_meme_otd_nautobot_1 ... done
Removing network nautobot_meme_otd_default
```
...
So for example, our plugin is named `nautobot-plugin-meme-otd`, the command would most likely be `docker logs nautobot_meme_otd_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_meme_otd")
namespace.configure(
    {
        "nautobot_meme_otd": {
            ...
...
Or set the `INVOKE_NAUTOBOT_MEME_OTD_PYTHON_VER` variable
...
Or set the `INVOKE_NAUTOBOT_MEME_OTD_NAUTOBOT_VER` variable
